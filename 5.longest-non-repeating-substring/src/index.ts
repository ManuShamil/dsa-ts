...
const isOutOfBounds = ( cursorPos: number, windowsSize: number, strLength: number ): boolean => {
    return cursorPos + windowsSize > strLength;
}

const hasDuplicates = ( str: string ): boolean => {
...
rl.question("Enter the string: ", ( str:string ) => {
